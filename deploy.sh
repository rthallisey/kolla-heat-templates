...
(cd kolla && sudo ./tools/build.py keystone nova glance mariadb haproxy keepalived memcached neutron openvswitch rabbitmq --base centos --tag latest --namespace kolla-tripleo -t binary --registry ${MYIP}:4000 --push)
